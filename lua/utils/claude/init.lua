...
local try_prewrite_gate         = gate.try_prewrite_gate
local resolve_permission        = gate.resolve_permission
local show_permission_card      = gate.show_permission_card
...
local EDIT_TOOLS                = gate.EDIT_TOOLS
local GATED_EDIT_TOOLS          = gate.GATED_EDIT_TOOLS
